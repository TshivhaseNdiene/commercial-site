<template>
    <header class="z-50 flex w-full flex-wrap bg-white pb-4 text-base sm:flex-col sm:pb-0">
        <!-- Topbar -->
        <div class="bg-white">
            <div class="container mx-auto px-4 sm:px-6 lg:px-8">
                <div
                    class="flex flex-col sm:flex-row justify-between items-center py-2 border-b border-gray-200 shadow-sm">
                ...
                <div class="flex justify-between items-center py-2">
                  ...
                  <div class="flex items-center space-x-4">
                    ...
                    <a href="#" class="flex items-center font-serif text-gray-800 hover:text-gray-500 dark:hover:text-gray-400 text-xs md:text-sm">
                      <svg class="mr-1 h-4 w-4 md:h-5 md:w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        <path d="M2.25 3h1.386c.51 0 .955.343 1.087.835l.383 1.437M7.5 14.25a3 3 0 0 0-3 3h15.75m-12.75-3h11.218c1.121-2.3 2.1-4.684 2.924-7.138a60.114 60.114 0 0 0-16.536-1.84M7.5 14.25 5.106 5.272M6 20.25a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0Zm12.75 0a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0Z" /></svg>
                            Cart
                          </a>
  
                        <!-- Search Icon -->
                        <a href="#"
                            class="flex items-center font-serif text-gray-800 hover:text-gray-500 dark:hover:text-gray-400 text-xs md:text-sm">
                            <svg class="mr-1 h-4 w-4 md:h-5 md:w-5" xmlns="http://www.w3.org/2000/svg" fill="none"
